...
export const en = {
  ...
  "cocodex.lock.title": "Project locked",
  "cocodex.lock.short": "Locked",
  "cocodex.lock.action": "Lock project",
  "cocodex.lock.unlock": "Unlock project",
  "cocodex.lock.defaultReason": "Shared changes and remote agent execution are paused by the project owner.",
  "cocodex.lock.unlockReason": "Project owner restored shared work.",
  "cocodex.lock.lockedNotice": "The project is locked. Shared changes and remote agent execution are paused.",
  "cocodex.lock.unlockedNotice": "The project is unlocked. New shared work can resume.",
  "cocodex.prompt.title": "Shared prompt",
  "cocodex.prompt.crdt": "Yjs CRDT · reconnect-safe",
  "cocodex.prompt.placeholder": "Edit a prompt together before sending it to an agent…",
  "cocodex.prompt.invalid": "The shared prompt update could not be applied.",
  "cocodex.prompt.typing": "typing…",
  "cocodex.prompt.caret": "caret {position}",
  "cocodex.prompt.selection": "selection {start}–{end}",
  ...
  "cocodex.usage.subtitle": "Signed local summaries",
  "cocodex.usage.fiveHour": "5-hour",
  "cocodex.usage.weekly": "Weekly",
  "cocodex.usage.monthly": "30-day",
  "cocodex.usage.requests": "{count} requests",
  "cocodex.usage.tokens": "{count} tokens",
  "cocodex.usage.active": "{count} active",
  "cocodex.usage.cacheHit": "{percent}% cached input",
  "cocodex.usage.updated": "Updated {time}",
  "cocodex.usage.reset": "resets {time}",
  "cocodex.usage.localAccount": "Local account",
  "cocodex.usage.unreported": "Not reported",
  "cocodex.usage.noData": "No signed usage report yet.",
  "cocodex.usage.noMembers": "No project members available.",
  "cocodex.agents.title": "Agents",
  "cocodex.agents.subtitle": "Shared host roster",
  "cocodex.agents.empty": "No agents configured.",
  "cocodex.agents.host": "Hosted by {host}",
  "cocodex.agents.tasks": "{active} active · {queued} queued",
  "cocodex.agents.offline": "Offline",
  "cocodex.agents.available": "Available",
  "cocodex.agents.queued": "Queued",
  "cocodex.agents.working": "Working",
  "cocodex.agents.completed": "Completed",
  "cocodex.agents.failed": "Failed",
  "cocodex.agent.setup.title": "Host an agent",
  "cocodex.agent.setup.subtitle": "Server identity plus local-only execution policy",
  "cocodex.agent.setup.name": "Agent display name",
  "cocodex.agent.setup.workspace": "Local repository path",
  "cocodex.agent.setup.primaryModel": "Primary model ID",
  "cocodex.agent.setup.maxCoAgents": "Maximum concurrent co-agents",
  "cocodex.agent.setup.coAgentModel": "Co-agent model ID",
  "cocodex.agent.setup.worktree": "Isolated Git worktree per task",
  "cocodex.agent.setup.shared": "Shared configured directory",
  "cocodex.agent.setup.device": "Trusted requester's device ID",
  "cocodex.agent.setup.fingerprint": "Trusted requester's fingerprint",
  "cocodex.agent.setup.action": "Create and configure",
  "cocodex.agent.setup.pending": "Agent setup sent. Waiting for server validation.",
  "cocodex.agent.setup.saved": "Agent configured locally. Reconnecting as its host.",
  "cocodex.tasks.title": "Task activity",
  "cocodex.tasks.subtitle": "Authoritative queue state",
  "cocodex.tasks.empty": "No task activity yet.",
  "cocodex.tasks.events": "{count} events",
  "cocodex.tasks.dependencies": "Waiting on {count} dependencies",
  "cocodex.tasks.artifacts": "{count} explicit artifact inputs",
  "cocodex.tasks.encrypted": "encrypted",
  "cocodex.tasks.workspace.shared": "Configured shared workspace",
  "cocodex.tasks.workspace.worktree": "Branch {branch} · base {commit}",
  "cocodex.tasks.queued": "Queued",
  "cocodex.tasks.working": "Working",
  "cocodex.tasks.completed": "Completed",
  "cocodex.tasks.failed": "Failed",
  ...
  "cocodex.agent.workspace.shared": "Workspace: shared configured directory",
  "cocodex.agent.workspace.worktree": "Workspace: isolated Git worktree per task",
  ...
  "cocodex.gitIntegration.integrate": "Integrate reviewed commit",  "cocodex.artifacts.title": "Artifact handoffs",
  "cocodex.artifacts.subtitle": "Select ready inputs for the chosen agent",
  "cocodex.artifacts.empty": "No shared artifacts yet.",
  "cocodex.artifacts.name": "Artifact title",
  "cocodex.artifacts.summary": "Short handoff summary",
  "cocodex.artifacts.content": "Artifact content",
  "cocodex.artifacts.publish": "Publish ready artifact",
  "cocodex.artifacts.queued": "Encrypted artifact queued for publication.",
  "cocodex.fileReferences.title": "Encrypted local file",
  "cocodex.fileReferences.subtitle": "Attach metadata only; file bytes stay on this computer.",
  "cocodex.fileReferences.artifact": "Choose this device's artifact",
  "cocodex.fileReferences.workspaceRoot": "Local workspace root",
  "cocodex.fileReferences.path": "File path inside workspace",
  "cocodex.fileReferences.shared": "Shared configured directory",
  "cocodex.fileReferences.worktree": "Git worktree",
  "cocodex.fileReferences.workspaceRef": "Workspace reference",
  "cocodex.fileReferences.mediaType": "Media type (optional)",
  "cocodex.fileReferences.publish": "Publish encrypted reference",
  "cocodex.fileReferences.queued": "Encrypted file reference queued for publication.",
  "cocodex.fileReferences.thisDevice": "available here",
  "cocodex.fileReferences.remoteDevice": "remote host",
  "cocodex.fileReferences.bytes": "{count} B",
  "cocodex.fileReferences.kilobytes": "{count} KB",
  "cocodex.fileReferences.megabytes": "{count} MB",
  "cocodex.encryption.rotationRequired": "Project key rotation is required before encrypted changes can continue.",
  "cocodex.security.deviceRevoked": "A project device was revoked. Remove it and rotate the project key before encrypted work continues.",
  "cocodex.security.deviceRevokedLocal": "This device was revoked from the project. Access is quarantined until it is re-enrolled with a newer project key.",
  "cocodex.security.promotedOwner": "Recovery owner: {device}",
  "cocodex.security.ownerRecovery": "Remove the revoked device and rotate the key to finish recovery.",
  ...
  "cocodex.projects.leave": "Leave project",
  "cocodex.projects.leaveHelp": "Leaving immediately revokes this device and freezes new project writes until the owner rotates the key.",
  "cocodex.projects.leaveConfirm": "Leave {name}? This device will lose access immediately. The project stays frozen until the owner completes key rotation.",
  "cocodex.projects.leaveQueued": "Your signed leave request was accepted or queued. Local project access will be revoked when the Server confirms it.",
  "cocodex.members.title": "Members",
  "cocodex.members.refresh": "Refresh project members",
  "cocodex.members.empty": "No project members loaded.",
  "cocodex.members.remove": "Remove",
  "cocodex.members.trust": "Verify",
  "cocodex.members.trusted": "verified",
  "cocodex.members.unverified": "unverified",
  "cocodex.members.trustConfirm": "Verify {name} using this cryptographic fingerprint?\n\n{fingerprint}",
  "cocodex.members.trustedNotice": "{name} is verified on this device.",
  "cocodex.members.removeConfirm": "Remove {name} ({fingerprint}) and rotate the project key? Their running tasks will be stopped.",
  "cocodex.members.removalQueued": "Removal and key rotation for {name} were securely queued.",
  "cocodex.members.revoked": "revoked",
  "cocodex.members.revokedRecovery": "Revoked device — remove it and rotate the project key.",
  "cocodex.members.removeAndRotate": "Remove & rotate",
  "cocodex.members.leaveRequestedHelp": "Leave requested \u2014 complete removal and owner-generated key rotation before project work can resume.",
  "cocodex.members.leaveRequestedOwner": "A member requested to leave. Complete removal and key rotation to resume project work.",
  "cocodex.members.completeLeave": "Complete leave & rotate",
  "cocodex.members.completeLeaveConfirm": "{name} ({fingerprint}) requested to leave. Remove them and generate the next project key? Their active work is already stopped.",
  ...
  "cocodex.agent.coagents.summary": "{count} co-agents · {model} · {effort}",
  "cocodex.agent.coagents.none": "Co-agents disabled",
  "cocodex.agent.none": "No local agent policy",
  "cocodex.agent.access": "Local access: {profile}",
  "cocodex.agent.execution.enabled": "Execution enabled",
  "cocodex.agent.execution.stopped": "Execution stopped",
  "cocodex.agent.fullComputer.disabled": "full-computer disabled",
  "cocodex.agent.safety.stop": "Emergency stop",
  "cocodex.agent.safety.stopAll": "Stop all agents",
  "cocodex.agent.safety.stopAllConfirm": "Emergency-stop every local agent on this computer? Queued and running work will be interrupted.",
  "cocodex.agent.safety.stoppedAll": "All local agents are stopped.",
  "cocodex.agent.safety.resume": "Resume",
  "cocodex.rail.title": "Workspace details",
  "cocodex.agent.fullComputer.enable": "Enable full-computer",
  "cocodex.agent.fullComputer.disable": "Disable full-computer",
  "cocodex.agent.fullComputer.confirm": "Enable full-computer Codex access on this device?",
  ...
  "cocodex.private.typing": "{name} is typing…",
  "cocodex.private.enableNotifications": "Enable notifications",
  "cocodex.private.disableNotifications": "Disable notifications",
  "cocodex.private.notificationsEnabled": "Notifications enabled.",
  "cocodex.private.notificationsDisabled": "Notifications disabled.",
  "cocodex.private.notificationsDenied": "Notification permission was not granted.",
  "cocodex.private.notificationTitle": "New private message",
  "cocodex.private.notificationBody": "{name} sent you an encrypted private message.",
  "cocodex.private.notificationFallback": "Trusted contact",
