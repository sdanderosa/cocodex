...
export const ko: Record<TKey, string> = {
  ...
  "cocodex.lock.title": "프로젝트 잠김",
  "cocodex.lock.short": "잠김",
  "cocodex.lock.action": "프로젝트 잠그기",
  "cocodex.lock.unlock": "프로젝트 잠금 해제",
  "cocodex.lock.defaultReason": "프로젝트 소유자가 공유 변경과 원격 에이전트 실행을 일시 중지했습니다.",
  "cocodex.lock.unlockReason": "프로젝트 소유자가 공유 작업을 재개했습니다.",
  "cocodex.lock.lockedNotice": "프로젝트가 잠겼습니다. 공유 변경과 원격 에이전트 실행이 일시 중지됩니다.",
  "cocodex.lock.unlockedNotice": "프로젝트 잠금이 해제되었습니다. 새 공유 작업을 재개할 수 있습니다.",
  "cocodex.prompt.title": "공유 프롬프트",
  "cocodex.prompt.crdt": "Yjs CRDT · 재연결 안전",
  "cocodex.prompt.placeholder": "에이전트에 보내기 전에 함께 프롬프트를 편집하세요…",
  "cocodex.prompt.invalid": "공유 프롬프트 업데이트를 적용할 수 없습니다.",
  "cocodex.prompt.typing": "입력 중…",
  "cocodex.prompt.caret": "커서 {position}",
  "cocodex.prompt.selection": "선택 {start}–{end}",
  ...
  "cocodex.usage.subtitle": "서명된 로컬 요약",
  "cocodex.usage.fiveHour": "5시간",
  "cocodex.usage.weekly": "주간",
  "cocodex.usage.monthly": "30일",
  "cocodex.usage.requests": "{count} 요청",
  "cocodex.usage.tokens": "{count} 토큰",
  "cocodex.usage.active": "{count} 실행 중",
  "cocodex.usage.cacheHit": "캐시된 입력 {percent}%",
  "cocodex.usage.updated": "업데이트 {time}",
  "cocodex.usage.reset": "재설정 {time}",
  "cocodex.usage.localAccount": "로컬 계정",
  "cocodex.usage.unreported": "보고되지 않음",
  "cocodex.usage.noData": "서명된 사용량 보고서가 아직 없습니다.",
  "cocodex.usage.noMembers": "사용 가능한 프로젝트 멤버가 없습니다.",
  "cocodex.agents.title": "Agents",
  "cocodex.agents.subtitle": "공유 호스트 목록",
  "cocodex.agents.empty": "구성된 에이전트가 없습니다.",
  "cocodex.agents.host": "호스트: {host}",
  "cocodex.agents.tasks": "{active} 활성 · {queued} 대기",
  "cocodex.agents.offline": "오프라인",
  "cocodex.agents.available": "사용 가능",
  "cocodex.agents.queued": "대기 중",
  "cocodex.agents.working": "작업 중",
  "cocodex.agents.completed": "완료",
  "cocodex.agents.failed": "실패",
  "cocodex.agent.setup.title": "에이전트 호스팅",
  "cocodex.agent.setup.subtitle": "서버 ID와 로컬 전용 실행 정책",
  "cocodex.agent.setup.name": "에이전트 표시 이름",
  "cocodex.agent.setup.workspace": "로컬 저장소 경로",
  "cocodex.agent.setup.primaryModel": "기본 모델 ID",
  "cocodex.agent.setup.maxCoAgents": "최대 동시 공동 에이전트",
  "cocodex.agent.setup.coAgentModel": "공동 에이전트 모델 ID",
  "cocodex.agent.setup.worktree": "작업별 격리 Git 워크트리",
  "cocodex.agent.setup.shared": "공유 설정 디렉터리",
  "cocodex.agent.setup.device": "신뢰할 요청자 장치 ID",
  "cocodex.agent.setup.fingerprint": "신뢰할 요청자 지문",
  "cocodex.agent.setup.action": "생성 및 설정",
  "cocodex.agent.setup.pending": "에이전트 설정을 보냈습니다. 서버 검증을 기다리는 중입니다.",
  "cocodex.agent.setup.saved": "에이전트를 로컬에 설정했습니다. 호스트로 다시 연결합니다.",
  "cocodex.tasks.title": "작업 활동",
  "cocodex.tasks.subtitle": "권위 있는 대기열 상태",
  "cocodex.tasks.empty": "아직 작업 활동이 없습니다.",
  "cocodex.tasks.events": "이벤트 {count}개",
  "cocodex.tasks.dependencies": "종속성 {count}개 대기 중",
  "cocodex.tasks.artifacts": "명시적 아티팩트 입력 {count}개",
  "cocodex.tasks.encrypted": "암호화됨",
  "cocodex.tasks.workspace.shared": "구성된 공유 작업 공간",
  "cocodex.tasks.workspace.worktree": "브랜치 {branch} · 기준 {commit}",
  "cocodex.tasks.queued": "대기 중",
  "cocodex.tasks.working": "작업 중",
  "cocodex.tasks.completed": "완료",
  "cocodex.tasks.failed": "실패",
  ...
  "cocodex.agent.workspace.shared": "작업 공간: 구성된 공유 디렉터리",
  "cocodex.agent.workspace.worktree": "작업 공간: 작업별 격리 Git worktree",
  ...
  "cocodex.gitIntegration.integrate": "Integrate reviewed commit",  "cocodex.artifacts.title": "아티팩트 전달",
  "cocodex.artifacts.subtitle": "선택한 에이전트에 전달할 준비된 입력을 선택하세요",
  "cocodex.artifacts.empty": "아직 공유된 아티팩트가 없습니다.",
  "cocodex.artifacts.name": "아티팩트 제목",
  "cocodex.artifacts.summary": "간단한 전달 요약",
  "cocodex.artifacts.content": "아티팩트 내용",
  "cocodex.artifacts.publish": "준비된 아티팩트 게시",
  "cocodex.artifacts.queued": "암호화된 아티팩트를 게시 대기열에 추가했습니다.",
  "cocodex.fileReferences.title": "암호화된 로컬 파일",
  "cocodex.fileReferences.subtitle": "메타데이터만 첨부하며 파일은 이 컴퓨터에 남습니다.",
  "cocodex.fileReferences.artifact": "이 장치의 아티팩트 선택",
  "cocodex.fileReferences.workspaceRoot": "로컬 작업 공간 루트",
  "cocodex.fileReferences.path": "작업 공간 내부 파일 경로",
  "cocodex.fileReferences.shared": "공유 구성 디렉터리",
  "cocodex.fileReferences.worktree": "Git 워크트리",
  "cocodex.fileReferences.workspaceRef": "작업 공간 참조",
  "cocodex.fileReferences.mediaType": "미디어 유형(선택 사항)",
  "cocodex.fileReferences.publish": "암호화된 참조 게시",
  "cocodex.fileReferences.queued": "암호화된 파일 참조를 게시 대기열에 추가했습니다.",
  "cocodex.fileReferences.thisDevice": "이 장치에서 사용 가능",
  "cocodex.fileReferences.remoteDevice": "원격 호스트",
  "cocodex.fileReferences.bytes": "{count} B",
  "cocodex.fileReferences.kilobytes": "{count} KB",
  "cocodex.fileReferences.megabytes": "{count} MB",
  "cocodex.encryption.rotationRequired": "암호화된 변경을 계속하려면 프로젝트 키를 로테이션해야 합니다.",
  "cocodex.security.deviceRevoked": "프로젝트 장치가 해지되었습니다. 암호화 작업을 계속하기 전에 해당 장치를 제거하고 프로젝트 키를 교체하세요.",
  "cocodex.security.deviceRevokedLocal": "이 장치는 프로젝트에서 해지되었습니다. 새 프로젝트 키로 다시 등록할 때까지 액세스가 격리됩니다.",
  "cocodex.security.promotedOwner": "복구 소유자: {device}",
  "cocodex.security.ownerRecovery": "해지된 장치를 제거하고 키를 교체하여 복구를 완료하세요.",
  ...
  "cocodex.projects.leave": "\ud504\ub85c\uc81d\ud2b8 \ub098\uac00\uae30",
  "cocodex.projects.leaveHelp": "\ub098\uac00\uba74 \uc774 \uc7a5\uce58\uc758 \uc811\uadfc \uad8c\ud55c\uc774 \uc989\uc2dc \ud3d0\uae30\ub418\uace0 \uc18c\uc720\uc790\uac00 \ud0a4\ub97c \uad50\uccb4\ud560 \ub54c\uae4c\uc9c0 \uc0c8 \ud504\ub85c\uc81d\ud2b8 \uc4f0\uae30\uac00 \uc911\uc9c0\ub429\ub2c8\ub2e4.",
  "cocodex.projects.leaveConfirm": "{name}\uc5d0\uc11c \ub098\uac00\uc2dc\uaca0\uc2b5\ub2c8\uae4c? \uc774 \uc7a5\uce58\ub294 \uc989\uc2dc \uc811\uadfc \uad8c\ud55c\uc744 \uc783\uace0 \uc18c\uc720\uc790\uac00 \ud0a4 \uad50\uccb4\ub97c \uc644\ub8cc\ud560 \ub54c\uae4c\uc9c0 \ud504\ub85c\uc81d\ud2b8\uac00 \uc911\uc9c0\ub429\ub2c8\ub2e4.",
  "cocodex.projects.leaveQueued": "\uc11c\uba85\ub41c \ub098\uac00\uae30 \uc694\uccad\uc774 \uc2b9\uc778\ub418\uc5c8\uac70\ub098 \uc548\uc804\ud558\uac8c \ub300\uae30\uc5f4\uc5d0 \uc800\uc7a5\ub418\uc5c8\uc2b5\ub2c8\ub2e4. Server \ud655\uc778 \ud6c4 \ub85c\uceec \uc811\uadfc \uad8c\ud55c\uc774 \ud3d0\uae30\ub429\ub2c8\ub2e4.",
  "cocodex.members.title": "멤버",
  "cocodex.members.refresh": "프로젝트 멤버 새로고침",
  "cocodex.members.empty": "불러온 프로젝트 멤버가 없습니다.",
  "cocodex.members.remove": "제거",
  "cocodex.members.trust": "확인",
  "cocodex.members.trusted": "확인됨",
  "cocodex.members.unverified": "확인되지 않음",
  "cocodex.members.trustConfirm": "이 암호화 지문으로 {name}을(를) 확인하시겠습니까?\n\n{fingerprint}",
  "cocodex.members.trustedNotice": "{name}이(가) 이 기기에서 확인되었습니다.",
  "cocodex.members.removeConfirm": "{name}({fingerprint})을 제거하고 프로젝트 키를 교체할까요? 실행 중인 작업은 중지됩니다.",
  "cocodex.members.removalQueued": "{name} 제거와 키 교체를 안전하게 대기열에 추가했습니다.",
  "cocodex.members.revoked": "해지됨",
  "cocodex.members.revokedRecovery": "해지된 장치 — 제거하고 프로젝트 키를 교체하세요.",
  "cocodex.members.removeAndRotate": "제거 및 교체",
  "cocodex.members.leaveRequestedHelp": "\ub098\uac00\uae30 \uc694\uccad\ub428 \u2014 \ud504\ub85c\uc81d\ud2b8 \uc791\uc5c5\uc744 \uc7ac\uac1c\ud558\uae30 \uc804\uc5d0 \uc81c\uac70 \ubc0f \uc18c\uc720\uc790 \uc0dd\uc131 \ud0a4 \uad50\uccb4\ub97c \uc644\ub8cc\ud558\uc138\uc694.",
  "cocodex.members.leaveRequestedOwner": "\uba64\ubc84\uac00 \ub098\uac00\uae30\ub97c \uc694\uccad\ud588\uc2b5\ub2c8\ub2e4. \uc81c\uac70 \ubc0f \ud0a4 \uad50\uccb4\ub97c \uc644\ub8cc\ud558\uba74 \ud504\ub85c\uc81d\ud2b8 \uc791\uc5c5\uc744 \uc7ac\uac1c\ud560 \uc218 \uc788\uc2b5\ub2c8\ub2e4.",
  "cocodex.members.completeLeave": "\ub098\uac00\uae30 \uc644\ub8cc \ubc0f \ud0a4 \uad50\uccb4",
  "cocodex.members.completeLeaveConfirm": "{name} ({fingerprint}) \ub2d8\uc774 \ub098\uac00\uae30\ub97c \uc694\uccad\ud588\uc2b5\ub2c8\ub2e4. \uc81c\uac70\ud558\uace0 \ub2e4\uc74c \ud504\ub85c\uc81d\ud2b8 \ud0a4\ub97c \uc0dd\uc131\ud558\uc2dc\uaca0\uc2b5\ub2c8\uae4c? \ud65c\uc131 \uc791\uc5c5\uc740 \uc774\ubbf8 \uc911\uc9c0\ub418\uc5c8\uc2b5\ub2c8\ub2e4.",
  ...
  "cocodex.agent.coagents.summary": "{count} 공동 에이전트 · {model} · {effort}",
  "cocodex.agent.coagents.none": "공동 에이전트 비활성화",
  "cocodex.agent.none": "No local agent policy",
  "cocodex.agent.access": "로컬 액세스: {profile}",
  "cocodex.agent.execution.enabled": "실행 활성화",
  "cocodex.agent.execution.stopped": "실행 중지",
  "cocodex.agent.fullComputer.disabled": "전체 컴퓨터 비활성화",
  "cocodex.agent.safety.stop": "긴급 중지",
  "cocodex.agent.safety.stopAll": "모든 에이전트 중지",
  "cocodex.agent.safety.stopAllConfirm": "이 컴퓨터의 모든 로컬 에이전트를 긴급 중지할까요? 대기 중이거나 실행 중인 작업이 중단됩니다.",
  "cocodex.agent.safety.stoppedAll": "모든 로컬 에이전트가 중지되었습니다.",
  "cocodex.agent.safety.resume": "재개",
  "cocodex.rail.title": "작업 공간 세부 정보",
  "cocodex.agent.fullComputer.enable": "전체 컴퓨터 활성화",
  "cocodex.agent.fullComputer.disable": "전체 컴퓨터 비활성화",
  "cocodex.agent.fullComputer.confirm": "이 장치에서 전체 컴퓨터 Codex 액세스를 활성화하시겠습니까?",
  ...
  "cocodex.private.typing": "{name}님이 입력 중…",
  "cocodex.private.enableNotifications": "알림 사용",
  "cocodex.private.disableNotifications": "알림 사용 안 함",
  "cocodex.private.notificationsEnabled": "알림을 사용 설정했습니다.",
  "cocodex.private.notificationsDisabled": "알림을 사용 중지했습니다.",
  "cocodex.private.notificationsDenied": "알림 권한이 허용되지 않았습니다.",
  "cocodex.private.notificationTitle": "새 비공개 메시지",
  "cocodex.private.notificationBody": "{name}님이 암호화된 비공개 메시지를 보냈습니다.",
  "cocodex.private.notificationFallback": "신뢰할 수 있는 연락처",
